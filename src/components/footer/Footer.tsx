      ...
      <section className="bg-slate-700 py-16 "> 
        <div className="max-w-screen-xl px-4 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8"> 
          ...
          <div className="px-5 py-2 ">
              <Link to="/home" className="text-base leading-6 text-white block md:px-4 transition duration-300 hover:text-cyan-500">
                Home
              </Link>
            </div>
            <div className="px-5 py-2 ">
              <Link to="/sobre" className="text-base leading-6 text-white block md:px-4 transition duration-300 hover:text-cyan-500">
                Sobre
              </Link>
            </div>
            <div className="px-5 py-2">
              <Link to="/team" className="text-base leading-6 text-white block md:px-4 transition duration-300 hover:text-cyan-500 ">
                Time
              </Link>
            </div>
            <div className="px-5 py-2">
              <a href="https://brasil.un.org/pt-br/sdgs/16" className="text-base leading-6 text-white block md:px-4 transition duration-300 hover:text-cyan-500">
                ONU
              </a>
            </div>
            <div className="px-5 py-2">
              <Link to="/contato" className="text-base leading-6 text-white block md:px-4 transition duration-300 hover:text-cyan-500">
                Contato
              </Link>
            </div>
          </nav>
